    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.infoBar}>
        ...
        <View style={{ flex: 1, marginRight: s(10) }}>
          <Text style={styles.infoTitle}>Wash Only</Text>
      ...
      <ScrollView
        ...
        contentContainerStyle={{ paddingBottom: mvs(120) }} // space for sticky buttons
      >
        <View style={styles.pricelistSection}>
          ...
          <View style={styles.pricelistItemRow}>
            <Text style={styles.pricelistItemDescription}>
              Mixed Wash (Up to 6 Kg) {"\n"}Light and dark clothes washed together at 30°C. Can request for other temperature.
            </Text>
      ...
      <View style={styles.fixedBottomBar}>
        ...
        <TouchableOpacity style={styles.buttonPrimary} onPress={() => router.push("/deliveryonly")}>
