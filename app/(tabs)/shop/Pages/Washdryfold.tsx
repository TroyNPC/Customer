  ...
  return (
    <SafeAreaView style={styles.safeArea}>
             {/* Header */}
                ...
                {/* Wash, Dry & Fold Info Bar (BELOW header, ABOVE pricelist) */}
                <View 
                  style={{
                    flexDirection: "row",
                  ...
                  <Image
                    source={{uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/4e530eb0-7f1a-44c4-939b-74ab94e932ea"}} 
                    resizeMode="stretch"
                    style={{
                      width: 88,
                      height: 88,
