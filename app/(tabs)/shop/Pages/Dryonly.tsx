...
export default function DryOnly() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
             {/* Header */}
                ...
                {/* Dry Only Info Bar (BELOW header, ABOVE pricelist) */}
                <View 
                  style={{
                    flexDirection: "row",
                  ...
                  <Image
                    source={{uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/874a9a95-075a-4ae4-88d2-b1da170afa1c"}} 
                    resizeMode="stretch"
                    style={{
                      width: 88,
                      height: 88,
        ...
        <View style={styles.pricelistSection}>
          ...
          <View style={styles.pricelistItemRow}>
            <Text style={styles.pricelistItemDescription}>
              Up to 6 KG {"\n"}Quick drying service for clothes that are already washed.
            </Text>
          ...
          <View style={styles.pricelistItemRowAlt}>
            <Text style={styles.pricelistItemDescription}>
              Up to 12 KG {"\n"}Suitable for larger loads of washed clothes that just need drying.
            </Text>
            <Text style={styles.pricelistItemPriceAlt}>₱360</Text>
          </View>
...
const styles = StyleSheet.create({
  // ✅ same styling as your Bulk code
  safeArea: {
    flex: 1,
