...
export default function FoldOnly() {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.infoBar}>
        <View style={{ flex: 1, marginRight: s(10) }}>
          <Text style={styles.infoTitle}>Fold Only</Text>
          <Text style={styles.infoDescription}>
            This Folding Service is for laundry that is already washed and dried
          </Text>
        </View>
        ...
        <View style={{ flexShrink: 0, justifyContent: "center", alignItems: "flex-end" }}>
          <Image
            source={{
              uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/1218c948-ff98-4eae-8a0c-49a3d5ed75cd",
            }}
            resizeMode="contain"
            style={{
              width: s(88),
          ...
          <View style={styles.pricelistSection}>
            ...
            <View style={styles.pricelistItemRow}>
              <Text style={styles.pricelistItemDescription}>
                Up to 6 KG {"\n"}Light and dark clothes folded neatly after washing.
              </Text>
            ...
            <View style={styles.pricelistItemRow}>
              <Text style={styles.pricelistItemDescription}>
                Up to 12 KG {"\n"}Clothes are folded neatly after being washed and dried.
              </Text>
              <Text style={styles.pricelistItemPrice}>₱540</Text>
            </View>

            <View style={styles.pricelistItemRowAlt}>
              <Text style={styles.pricelistItemDescription}>
                Each Additional 1 KG {"\n"}Extra folding charged per kilogram beyond the first load.
              </Text>
              <Text style={styles.pricelistItemPriceAlt}>₱45</Text>
            </View>
          </View>
        </ScrollView>
